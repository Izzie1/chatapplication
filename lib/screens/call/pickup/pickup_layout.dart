...
import 'package:funchat/screens/call/pickup/pickup_screen.dart';
...
class PickupLayout extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return (accountProvider != null && accountProvider.getAccount != null) ?
    StreamBuilder<DocumentSnapshot> (
      stream: callMethods.callStream(uid: accountProvider.getAccount.uid),
